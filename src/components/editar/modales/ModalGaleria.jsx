        ...
        <div className="foto-actual">
          <div className="foto-actual-inner">
            ...
            <div>
              {fotoSeleccionada ? (
                <img
                  src={"/images/disenador/gallery/" + fotoSeleccionada}
                  alt="Foto seleccionada"
                />
              ) : (
                <span>Ninguna foto</span>
              )}
            </div>
          </div>
          <button type="button" disabled={!fotoSeleccionada} onClick={agregar}>
            Agregar foto al diseño
          </button>
        </div>
        <div className="scroll">
          {GALERIA.map((categoria, i) => (
            <Categoria
              key={"categoria-" + i}
              categoria={categoria}
              pos={i}
              seleccionar={setFotoSeleccionada}
            />
          ))}
        </div>
      </div>
